...
def run_smoke(binary: str, timeout: int, keep_temporary_projects: bool) -> None:
    ...
    require(len(expected_tools) == 110, f"Tool manifest must contain 110 tools, found {len(expected_tools)}.")
    ...
    try:
        ...
        print("[6/9] Checking stdio JSON, 110-tool manifest, settings, classes, and scripts")
        surface_requests = [
        ...
        require(
            ...
            "tools/list did not match the ordered 110-tool manifest: "
